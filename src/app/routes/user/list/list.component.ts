    ...
    if (this.type === 1) {
      this.http
        ...
        .subscribe(res => {
          ...
          // size of the diagram
          // let ele = document.getElementById('tree-container');
          var viewerWidth = 1552;
          ...
          function update(source) {
            ...
            nodes.forEach(function (d) {
              d.y = (d.depth * (maxLabelLength * 75)); //maxLabelLength * 10px
            ...
            nodeEnter.append("text")
              .attr("x", function (d) {
                return d.children || d._children ? 56 : 10;
              })
              .attr("dy", function (d) {
                return d.children ? '-0.65em' : ".35em"
              })
              .attr('class', 'nodeText')
